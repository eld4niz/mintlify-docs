...
description: "Add support for any depth camera in under 20 minutes with the SensorBase interface"
---
...
<CardGroup cols={2}>
  <Card title="Test with SLAM" icon="play" href="/examples/basic-slam">
    Run SLAM with your new sensor
  </Card>

  <Card title="Share Your Integration" icon="share" href="https://github.com/neuronav-io/neuronav-slam-sdk">
...
1. Fork the [Neuronav SDK repository](https://github.com/neuronav-io/neuronav-slam-sdk)
